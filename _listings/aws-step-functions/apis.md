...
- name: AWS Step Functions API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-step-functions/master/_listings/aws-step-functions/action-stopexecution-get.md
x-common:
